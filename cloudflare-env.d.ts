/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3159c408ab3b26978fce30d79d9440c8)
// Runtime types generated with workerd@1.20260921.1 2026-09-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	EMAIL_FROM: "Build-a-Date <hello@build-a-date.cals.cafe>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
